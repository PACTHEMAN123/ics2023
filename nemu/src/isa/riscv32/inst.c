...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw  , I, R(rd) = cpu.csr[get_csr(imm)]; cpu.csr[get_csr(imm)] = src1);
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, isa_raise_intr(0, cpu.pc));
