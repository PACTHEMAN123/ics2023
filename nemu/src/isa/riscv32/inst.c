...
#define R(i) gpr(i)
#define C(imm) (cpu.csr[get_csr(imm)])
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, bool success = false; s->dnpc = isa_raise_intr(isa_reg_str2val("a7", &success), s->snpc));
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, s->dnpc = cpu.csr[1] + 4); 
